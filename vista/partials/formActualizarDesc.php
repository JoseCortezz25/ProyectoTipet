                    ...
                    <form class="formActualizarDesc" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                      <textarea name="descipcionPerfil" cols="30" placeholder="Descripcion" rows="10" maxlength="170" required></textarea>
                    ...
                    <?php
                      if (isset($_POST["descipcionPerfil"])){
                          ...
                          $ActuDescripcion = $obj -> ActualizarDescripcion($descipcionPerfil2,$_SESSION["usuario"]["id"]);
