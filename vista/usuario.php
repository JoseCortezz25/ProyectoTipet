                      ...
                      <div class="contenedorInferior">
                        ...
                        <?php $obtenerNumeros = $obj -> obtenerNumeros($publicaciones['idUsuario']);?> 
                          ...
                          <?php else: ?> 
                            ...
                            <div class="panel">
                              <?php 
                                $mensaje = 'Hola, soy ' . $_SESSION["usuario"]["nombre"] . ' estoy interesado en ' . $publicaciones['nombreMascota'] . '. Quiera saber mas informacion sobre el. Gracias.' .' ' .'*Mensaje enviado desde Tipet*';
                              ?>
                              <a class="botonRegistrarse" href="https://api.whatsapp.com/send?phone=57<?php echo $obtenerNumeros['numero']; ?>&text=<?php echo $mensaje;?>" id="mensaje<?php echo $num; ?>">Enviar mensaje</a> 
